...
import { Brain, Code, Users, Shield, Target, ArrowRight, ArrowLeft, CheckCircle } from "lucide-react";
              ...
              {questions.map((_, index) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    const canJump = index === 0 || 
                      Object.keys(answers).length >= index || 
                      (index > 0 && answers[questions[index-1]?.id] !== undefined);
                  ...
                  >
                    {options.map((option) => (
                      ...
                      >
                        ...
                        />
                        <Label htmlFor={`${questions[currentQuestionIndex].id}-${option.value}`} className="w-full cursor-pointer">
                          {option.label}
                        </Label>
                      </div>
                    ))}
